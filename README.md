...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|goods\_shouyin\_id|Integer|购买|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|goods\_churu\_inout\_id|Integer|出入库|是|
|3|goods\_id|Integer|商品|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|goods\_shouyin\_uuid\_number|String|购买流水号|是|
|3|yonghu\_id|Integer|用户|是|
|4|goods\_shouyin\_true\_price|BigDecimal|实付金额|是|
|5|goods\_shouyin\_types|Integer|支付类型|是|
...
|7|goods\_new\_money|BigDecimal|原价|是|
|8|goods\_xiaoshou\_money|BigDecimal|现价|是|
